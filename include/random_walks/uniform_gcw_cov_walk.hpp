...
#ifndef RANDOM_WALKS_UNIFORM_GCW_COV_WALK_HPP
#define RANDOM_WALKS_UNIFORM_GCW_COV_WALK_HPP
...
struct Walk
{
    ...
    Walk(GenericPolytope const& P, VT& p, MT &sigma, RandomNumberGenerator& rng)
    {
        _sigma = sigma;
