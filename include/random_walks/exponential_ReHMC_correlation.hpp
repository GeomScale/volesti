...
// Reflective HMC for sampling from the Exponential distribution restricted to a convex polytope
...
struct Walk
{
                      ...
                      RandomNumberGenerator &rng)
    {
        ...
        for(int i = 0; i < walkL; ++i){
            T = rng.sample_urdist() * _Len; // leap total distance T = 
            _v = GetDirection<Point>::apply(n, rng, false);
            p = p0;
            h1 = Hamiltonian<NT>(_p, _v);
