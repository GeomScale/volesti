...
T expint_i_imp(T z, const Policy& pol, const mpl::int_<53>& tag)
{
   ...
   if(z <= 6)
   {
      ...
      static const T r2 = BOOST_MATH_BIG_CONSTANT(T, 53, 0.13140183414386028200928038740935716551555657435242201206362e-16);
      static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 53, 0.37250741078136663446199186658011913353568949777165405155565743524220120636201854384926049951548942392));
      T t = (z / 3) - 1;
...
T expint_i_imp(T z, const Policy& pol, const mpl::int_<64>& tag)
{
   ...
   if(z <= 6)
   {
      ...
      static const T r2 = BOOST_MATH_BIG_CONSTANT(T, 64, 0.13140183414386028200928038740935716551555657435242201206362e-16);
      static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 64, 0.37250741078136663446199186658011913353568949777165405155565743524220120636201854384926049951548942392));
      T t = (z / 3) - 1;
      result = tools::evaluate_polynomial(P, t) 
         / tools::evaluate_polynomial(Q, t);
      t = (z - r1) - r2;
...
void expint_i_imp_113a(T& result, const T& z, const Policy& pol)
{
   ...
   static const T r = static_cast<T>(BOOST_MATH_BIG_CONSTANT(T, 113, 0.37250741078136663446199186658011913353568949777165405155565743524220120636201854384926049951548942392));
   T t = (z / 3) - 1;
   result = tools::evaluate_polynomial(P, t) 
      / tools::evaluate_polynomial(Q, t);
   t = ((z - r1) - r2) - r3;
