...
//#define R_D__0 (log_p ? ML_NEGINF : 0.) // C++ forbid use of __
//#define R_D__1 (log_p ? 0. : 1.)        // C++ forbid use of __

#define R_D_0 (log_p ? ML_NEGINF : 0.0)
#define R_D_1 (log_p ? 0.0 : 1.0)
#define SIXTEN  16 /* Cutoff allowing exact "*" and "/" */

void pnorm_both(double x,
                double *cum,
                double *ccum,
                int i_tail,
                int log_p)
