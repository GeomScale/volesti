...
#include "lusol2.h"      /* Heap management */
#include "lusol6a.h"     /* Singularity checking and equation solving */
#include "lusol1.h"      /* Factorization and core components */
#include "lusol7a.h"     /* Utility routines for updates */
#include "lusol8a.h"     /* Column update */
