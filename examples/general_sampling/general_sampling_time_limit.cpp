...
#include "generators/custom_generators.h"
...
int main(int argc, char const *argv[]) {
    ...
    active_methods["BilliardWalk"]            = true;
    active_methods["RDHRWalk"]                = true;
    active_methods["CRHMCWalk"]               = true;
    active_methods["SparseBilliardWalk"]      = true; 
