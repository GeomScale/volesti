...
# Run tests for the generate_samples() function
    ...
    samples = p.generate_samples(walk_len = 1, number_of_points = 1000, number_of_points_to_burn = 50, boundary = True, cdhr = True, rdhr = False, gaussian = False, set_L = False, billiard = False, ball_walk = False, a = 0, L = 0)
