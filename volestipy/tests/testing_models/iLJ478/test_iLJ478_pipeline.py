...
input_file = '../../bigg_files/iLJ478.json'
...
print("Initial A rows and columns:")
...
print("Processed A rows and columns:")
print(A_proc.shape[0]) ; print(A_proc.shape[1])
print("Processed Aeq rows and columns:")
print(Aeq_proc.shape[0]) ; print(Aeq_proc.shape[1])
