...
RCPP_MODULE(polytopes){
    ...
    //' @export
    class_<VpolytopeIntersection>("VpolytopeIntersection")
    // expose the default constructor
    .constructor()
    .constructor<Rcpp::NumericMatrix, Rcpp::NumericMatrix>()
    .constructor<Rcpp::NumericMatrix, Rcpp::NumericMatrix, double>()

    .field( "V1", &VpolytopeIntersection::V1 )
    .field( "V2", &VpolytopeIntersection::V2 )
    .field( "volume", &VpolytopeIntersection::vol )
    .field( "dimension", &VpolytopeIntersection::dimension )
    .field( "type", &VpolytopeIntersection::type );
}
