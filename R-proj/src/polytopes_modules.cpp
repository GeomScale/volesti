...
public:
    ...
    sparse_constraint_problem(SpMat _Aeq, Rcpp::NumericVector _beq, Rcpp::NumericVector _lb, Rcpp::NumericVector _ub) : 
                        Aeq(_Aeq), beq(_beq), lb(_lb), ub(_ub), Aineq(SpMat(0, _Aeq.cols())), bineq(Rcpp::NumericVector(0)), dimension(_Aeq.cols()), type(5) {}
    SpMat Aineq;
...
RCPP_MODULE(polytopes){
    ...
    .constructor<SpMat, Rcpp::NumericVector, Rcpp::NumericVector, Rcpp::NumericVector>()
