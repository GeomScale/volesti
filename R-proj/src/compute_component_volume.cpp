...
//' @export
// [[Rcpp::export]]
Rcpp::NumericMatrix compute_component_volume(Rcpp::NumericMatrix A,
                                     ...
                                     double error)
{
    ...
    NT vol = volume_component_cooling_gaussians<GaussianGCWalk>(BS, p, mu, sigma, samples, rng, error);
