...
ban_volume <- function(P, e = 0.1, steps_only = FALSE, const_win = TRUE, rounding = FALSE, verbose = FALSE, lb_ratio = 0.1, ub_ratio = 0.15) {
    .Call('_volesti_ban_volume', PACKAGE = 'volesti', P, e, steps_only, const_win, rounding, verbose, lb_ratio, ub_ratio)
}
