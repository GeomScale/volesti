...
ZonoBallAnn <- function(P, e, verbose = FALSE, lb_ratio = 0.1, ub_ratio = 0.2) {
    .Call('_volesti_ZonoBallAnn', PACKAGE = 'volesti', P, e, verbose, lb_ratio, ub_ratio)
}

vol_zono <- function(P, e, verbose = FALSE, delta_in = 0.0, up_lim = 0.15) {
