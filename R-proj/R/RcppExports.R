...
#' P = GenCube(3, 'V')
#' points = sample(P, WalkType = "BW", walk_length = 5)
#'
#' # gaussian distribution from the 2d unit simplex in H-representation with variance = 2
#' A = matrix(c(-1,0,0,-1,1,1), ncol=2, nrow=3, byrow=TRUE)
#' b = c(0,0,1)
#' P = Hpolytope$new(A,b)
#' points = sample(P, distribution = "gaussian", parameters = list("variance" = 2))
#'
#' # uniform points from the boundary of a 10-dimensional hypersphere
#' points = sample(exact = TRUE, body = "hypersphere", parameters = list("dimension" = 10))
#'
#' # 10000 uniform points from a 2-d arbitrary simplex
#' V = matrix(c(2,3,-1,7,0,0),ncol = 2, nrow = 3, byrow = TRUE)
#' P = Vpolytope$new(V)
#' points = sample(P, N = 10000, exact = TRUE)
#' @export
sample <- function(P = NULL, N = NULL, distribution = NULL, WalkType = NULL, walk_length = NULL, exact = NULL, body = NULL, parameters = NULL, InnerPoint = NULL) {
    .Call(`_volesti_sample`, P, N, distribution, WalkType, walk_length, exact, body, parameters, InnerPoint)
}
...
#' @export
volume <- function(P, walk_length = NULL, error = NULL, InnerBall = NULL, algo = NULL, random_walk = NULL, rounding = NULL, parameters = NULL) {
    .Call(`_volesti_volume`, P, walk_length, error, InnerBall, algo, random_walk, rounding, parameters)
}
