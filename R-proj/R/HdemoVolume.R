...
HdemoVolume <- function(algo){
  ...
  Hruntest(PolyList$matrix, PolyList$vector, 'H-cube10', 1024, 0.1, num_of_exps, algo)
  
  print('H-cube20')
  PolyList = GenCube(20, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-cube20', 1048576, 0.1, num_of_exps, algo)
  
  print('H-cube30')
  PolyList = GenCube(30, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-cube30', 1073742000, 0.2, num_of_exps, algo)
  ...
  Hruntest(PolyList$matrix, PolyList$vector, 'H-cross10', 0.0002821869, 0.1, num_of_exps, algo)
  ...
  x = modifyMat(A)
  Hruntest(x$matrix, x$vector, 'H-birk3', 0.125, 0.1, num_of_exps, algo)
  
  print('H-birk4')
  A = ineToMatrix(read.csv(paste0(path,'birk4.ine')))
  x = modifyMat(A)
  Hruntest(x$matrix, x$vector, 'H-birk4', 0.000970018, 0.2, num_of_exps, algo)
  
  print('H-birk5')
  A = ineToMatrix(read.csv(paste0(path,'birk5.ine')))
  x = modifyMat(A)
  Hruntest(x$matrix, x$vector, 'H-birk5', 0.000000225, 0.2, num_of_exps, algo)
  
  print('H-birk6')
  A = ineToMatrix(read.csv(paste0(path,'birk6.ine')))
  x = modifyMat(A)
  Hruntest(x$matrix, x$vector, 'H-birk6', 0.0000000000009455459196, 0.5, num_of_exps, algo)
  ...
  Hruntest(PolyList$matrix, PolyList$vector, 'H-prod_simplex_5_5', (1/prod(1:5))^2, 0.1, num_of_exps, algo)
  
  print('H-prod_simplex_10_10')
  PolyList = GenProdSimplex(10)
  Hruntest(PolyList$matrix, PolyList$vector, 'H-prod_simplex_10_10', (1/prod(1:10))^2, 0.1, num_of_exps, algo)
  
  print('H-prod_simplex_15_15')
  PolyList = GenProdSimplex(15)
  Hruntest(PolyList$matrix, PolyList$vector, 'H-prod_simplex_15_15', (1/prod(1:15))^2, 0.1, num_of_exps, algo)
  
  print('H-prod_simplex_20_20')
  PolyList = GenProdSimplex(20)
  Hruntest(PolyList$matrix, PolyList$vector, 'H-prod_simplex_20_20', (1/prod(1:20))^2, 0.1, num_of_exps, algo)
  ...
  Hruntest(PolyList$matrix, PolyList$vector, 'H-simplex10', (1/prod(1:10)), 0.1, num_of_exps, algo)
  
  print('H-simplex20')
  PolyList = GenSimplex(20, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-simplex20', (1/prod(1:20)), 0.1, num_of_exps, algo)
  
  print('H-simplex30')
  PolyList = GenSimplex(30, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-simplex30', (1/prod(1:30)), 0.1, num_of_exps, algo)
  
  print('H-simplex40')
  PolyList = GenSimplex(40, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-simplex40', (1/prod(1:40)), 0.1, num_of_exps, algo)
  
  print('H-simplex50')
  PolyList = GenSimplex(50, 'H')
  Hruntest(PolyList$matrix, PolyList$vector, 'H-simplex50', (1/prod(1:50)), 0.1, num_of_exps, algo)
  ...
  if(algo=="SOB"){
    ...
    Hruntest(PolyList$matrix, PolyList$vector, 'H-skinny_cube10', 102400, 0.1, num_of_exps, algo)
