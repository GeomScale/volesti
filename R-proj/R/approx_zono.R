...
#' Z = GenZonotope(2,10)
#' retList = approx_zono(Z = Z, fit_ratio = TRUE)
#' 
#' @export
approx_zono <- function(Z, fit_ratio = NULL, walk_step = NULL, error = NULL,
                        InnerBall = NULL, WalkType = NULL, rounding = NULL,
                        Parameters = NULL){
  
  ret_list = zono_approx(Z, fit_ratio, walk_step, error, InnerBall, WalkType, rounding, Parameters)
