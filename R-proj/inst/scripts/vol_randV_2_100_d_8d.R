...
for (i in c(seq(from=55,to=100,by=5))) {
  print(i)
  ...
  save(times1, file = "1xtimes1_55_100_randV_d_8d.RData")
  #save(times2, file = "times2_2_14_randV_d_6d.RData")
  #save(errors1, file = "errors_2_14_randV_d_6d.RData")
  save(vols1, file = "1xvols_55_100_randV_d_8d.RData")
  save(steps1, file = "1xsteps_55_100_randV_d_8d.RData")
  save(nballs1, file = "1xnballs_55_100_randV_d_8d.RData")
