...
for (i in 2:dimen) {
  ...
  save(times1, file = "times_2_35_d_20d_ball.RData")
  save(steps1, file = "steps_2_35_d_20d_ball.RData")
  save(nballs, file = "nballs_2_35_d_20d_ball.RData")
