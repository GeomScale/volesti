...
for (i in c(2,seq(from=5,to=40,by=5))) {
  ...
  save(times1, file = "times_2_40_d_10d_ball.RData")
  save(steps1, file = "steps_2_40_d_10d_ball.RData")
  save(nballs1, file = "nballs_2_40_d_10d_ball.RData")
