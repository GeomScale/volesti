...
for (i in c(10,seq(from=15,to=100,by=5))) {
  ...
  save(times1, file = "5xtimes1_2_100_randV_d_10d.RData")
  #save(times2, file = "times2_2_14_randV_d_6d.RData")
  #save(errors1, file = "errors_2_14_randV_d_6d.RData")
  save(vols1, file = "5xvols_2_100_randV_d_10d.RData")
  save(steps1, file = "5xsteps_2_100_randV_d_10d.RData")
  save(nballs1, file = "5xnballs_2_100_randV_d_10d.RData")
