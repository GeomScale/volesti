...
I created a new class stdVPolytope in the header file polytopes.h. I implemented the member function is_in() using linear programming as it is described at http://www.cs.mcgill.ca/~fukuda/soft/polyfaq/node22.html.
