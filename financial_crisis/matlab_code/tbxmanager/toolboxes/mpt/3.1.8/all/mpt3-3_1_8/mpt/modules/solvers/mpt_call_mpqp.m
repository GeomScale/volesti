...
%  DESCRIPTION
%  -----------
%     The function call to MPQP solver from Opt class. Using option settings for
%  MPQP solver taken from MPT2.6.
%  
%  INPUT
%  -----
%     
...
%                         Class: struct                            
%                         Default: []                              
%          S.recover      Affine map for MPQP problems if there    
...
%                                      Class: PolyUnion                         
%          R.mpqpsol                   Structure with the solution as returned  
%                                      by MPQP solver.                          
%                                      Class: struct                            
%          R.mpqpsol.Pn                Array of polytopes in MPT2 format.       
%                                      Class: polytope                          
%          R.mpqpsol.Fi                Cell array of matrices of the control    
%                                      law given as x=F_itheta + G_i.           
%                                      Class: cell                              
%          R.mpqpsol.Gi                Cell array of matrices of the control    
%                                      law given as x=F_itheta + G_i.           
%                                      Class: cell                              
%          R.mpqpsol.activeConstraints Index set of active constraints          
%                                      Class: cell                              
%          R.mpqpsol.Phard             Feasible domain.                         
%                                      Class: polytope                          
%          R.mpqpsol.details           More details about the solution and the  
%                                      computation.                             
%                                      Class: struct                            
%                                        
%  
